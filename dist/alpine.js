    ...
    function runIfTypeOfFunction(receiver, value, scope, params) {
        if (typeof value === "function") {
            ...
            if (result instanceof Promise) {
                result.then((i) =>
                    runIfTypeOfFunction(receiver, i, scope, params)
                );
            } else {
                receiver(result);
            }
...
`,
    ...
    function attributeShouldntBePreservedIfFalsy(name) {
        return !["aria-pressed", "aria-checked", "aria-expanded"].includes(
            name
        );
    }
    ...
    directive(
        ...
        skipDuringClone((el, { expression }) => {
            if (typeof expression === "string") {
                return (
                    !!expression.trim() && evaluate(el, expression, {}, false)
                );
            }

...
setTimeout(() => {
    ...
    if (time) {
        ...
        if (!SCREENSHOT_MODE) {
            getUserHour(
                (twelveHour) => (time.textContent = getTime(twelveHour))
            );
        } else {
...
if (
    ...
    getTopSiteValue().then(
        (topSitesValue) => (topSitesSwitch.checked = topSitesValue)
    );
    // Event Listeners
...
function getTopSiteContainer() {
    return __awaiter(this, void 0, void 0, function* () {
        const storageResponse = yield browser.storage.local.get(
            "topSitesContainer"
        );
...
function toggleTopSiteContainer() {
    return __awaiter(this, void 0, void 0, function* () {
        const currentPosition =
            (topSitesContainer === null || topSitesContainer === void 0
                ? void 0
                : topSitesContainer.id) === "topSitesCenter"
                ? "center"
                : "topLeft";
...
function getTopSiteValue() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return storageResponse.topSites
            ? storageResponse.topSites === true
            : false;
    });
}
        ...
        (storageResponse) => {
            if (
                ...
                toDataURL(`https://api.faviconkit.com/${siteHost}`)
                    .then((dataUrl) => {
                        browser.storage.local.set({
                            topSitesFavicons: Object.assign(
                                Object.assign(
                                    {},
                                    storageResponse.topSitesFavicons
                                ),
...
function getUnsplashImage() {
    return __awaiter(this, void 0, void 0, function* () {
        const randomImage = yield fetch(
            `${proxyUrl}/random?collections=935518`
        );
        const randomImageJson = yield randomImage.json();
        const encodedUrl = encodeURIComponent(
            randomImageJson.links.download_location
        );
        const downloadUrl = yield fetch(
